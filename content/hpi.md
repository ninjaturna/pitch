...
HP Inc has committed to $1B in productivity gains through AI-enabled transformation by FY2028. NTT has supported HP's development organization for years, but adding headcount has not moved velocity proportionally. Project Armor is in motion and the open question inside it is methodology. Launch is the layer above delivery — the team that figures out what the engineering organization should build, in what order, and how to set them up to succeed.
...
| | |
|---|---|
| **Prepared for** | Tam Danier, SA Advisory — internal review |
| **Client stakeholder** | Claude Boivin, SVP Sales and Supply Chain Solutions, HP Inc |
| **Status** | v7 — fact-checked, voice-passed |
| **Deck format** | 7 slides + appendix |
...
**FOOTER**
Before we say anything about us — does that frame match where you are?
...
**BODY**
LEFT: The layer above execution
...
RIGHT: Different from what HP already has
...
> **GRAPHIC PROMPT — Frictionless Enterprise pyramid**
> "Vertical pyramid diagram, 4 tiers. Top tier (smallest): 'Strategy & Methodology'. Second: 'Governance & Operating Conditions'. Third: 'Delivery Practices'. Bottom (widest): 'Engineering Capacity'. Gold accent on top tier, blue gradient down. Tier labels on the right. Clean, executive. SIGNAL brand style."

---

### SLIDE 3 | AI TOOLS AREN'T THE PROBLEM
...
### SLIDE 5 | CASE STUDY — COVER MY MEDS
...
### SLIDE 6 | THE CONVERSATION WORTH HAVING
...
**FOOTER**
We can develop a specific POV focusing on where Launch can help.
...
### APPENDIX A | APP RATIONALIZATION METHODOLOGY
...
*Prepared by Tam Danier, SA Advisory — Launch by NTT DATA*
*v7 fact-checked April 29, 2026 · Voice pass April 30, 2026*
